<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmInformationSuministrationNPS.aspx.cs" Inherits="AppWebShopFFF.frmInformationSuministration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="descripcion">
        <article class="article descripcion__article">
            <h3 class="descripcion__title">Consultar información suministrada (NPS)</h3>
            <p class="descripcion__info">Es esta sección, se podrá consultar, mediante un rango de fechas, la información con respecto a las Net Promoter Score (NPS) efectuadas dentro de las fechas especificadas.
            </p>
        </article>
    </section>
            ...
            <asp:GridView class="consult__gridview" runat="server"
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="nombre" 
                        HeaderText="Estado"
                        HeaderStyle-CssClass="bg-secondary  TextoContenido"  />
                  <asp:BoundField DataField="marca" HeaderText="Fecha de realización"
                        HeaderStyle-CssClass="bg-secondary  TextoContenido"  />
               </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="sqlDatos" runat="server" ConnectionString='<%$ ConnectionStrings:DbFFFConnectionString %>' 
                SelectCommand="SELECT [codigo], [nombre], [marca] FROM [TblArticulo]" />
      </article>
     </section>
</asp:Content>
